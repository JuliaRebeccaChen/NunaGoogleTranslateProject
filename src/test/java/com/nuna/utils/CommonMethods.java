...
public class CommonMethods extends PageInitializer {
	...
	/**
	 * This method compares expectedText and actualText, and print a result.
	 * 
	 * @param expectedText
	 * @param actualText
	 */
	...
	/**
	 * This method gets the Alert text. If no alert is present then the exception is
	 * caught and it returns null.
	 * 
	 * @return
	 */
	...
	/**
	 * This method clicks the element that is passed using JavascriptExecutor.
	 * 
	 * @param element
	 */
	...
	/**
	 * This method scrolls the page until the element that is passed becomes visible
	 * 
	 * @param element
	 */
	...
	/**
	 * This method scrolls the page down based on the passed pixel parameter.
	 * 
	 * @param pixel
	 */
	...
	/**
	 * This method scrolls the page up based on the passed pixel parameter.
	 * 
	 * @param pixel
	 */
	...
	/**
	 * This method selects a date from the calendar.
	 * 
	 * @param elements
	 * @param date
	 */
	...
	public static byte[] takeScreenshot(String filename) {
		...
		// Creates unique filename: e.g. name+timestamp
		...
		// Gets the screenshot as a byte[] and return it
